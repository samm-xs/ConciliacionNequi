# Delta for Local Reconciliation API
...
(Previously: download URL was optional metadata for a future frontend.)
...
(Previously: verification covered only API request and response shape.)
